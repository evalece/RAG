...
class VectorDB:
    def __init__(self, data_dir, embedding_model=default_embedding, ):
        self.embedding_model= embedding_model
        self.data_dir=data_dir

    def embed(self, data_dir= False, embedding_model=False): #store data_dir on embedding model
    ...
    def set_out_dir(): # setting embedding output directory: 
